...
<body>
    <h5 class="fw-semibold text-uppercase">Medicamentos por categoria</h5>
    <h6 class="text-uppercase"><span class="fw-semibold">Categoria:</span>&nbsp;<span class="fw-regular">{{ $categoria }}</span></h6>
    <br>
