...
<body>
    <h5 class="fw-semibold text-uppercase">Reporte de vencimientos</h5>
    <h6 class="text-uppercase"><span class="fw-semibold">Fecha vto.:</span>&nbsp;<span class="fw-regular">{{ $fecha }}</span></h6>
    <br>
    <table class="table table-borderless">
        ...
        <tbody>
            ...
            @else
            <tr>
                <td class="fw-regular text-uppercase py-1" colspan="8">No hay registros</td>
            </tr>
            @endif
        </tbody>
    </table>
