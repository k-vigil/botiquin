...
<body>
    <h5 class="fw-semibold text-uppercase">Medicamentos por lote</h5>
    <h6 class="text-uppercase"><span class="fw-semibold">Lote:</span>&nbsp;<span class="fw-regular">{{ $lote }}</span></h6>
    <br>
